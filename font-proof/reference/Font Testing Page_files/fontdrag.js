...
domElements[0].style.fontFamily = name + ', gentlinesregular';
...
displayContainer.style.fontFamily = name + ', gentlinesregular';
};
...
displayContainer.style.fontFamily += ', gentlinesregular';
